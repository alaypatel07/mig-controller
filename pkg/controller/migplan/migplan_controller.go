...
func (r ReconcileMigPlan) ensureMigPlanRunningLabel(plan *migapi.MigPlan) error {
	...
	if plan.Labels != nil {
		// migplan does not have any running migmigration remove the label
...
func (r ReconcileMigPlan) ensureMigPlanFailedLabel(plan *migapi.MigPlan) error {
	...
	if plan.Labels != nil {
		// migplan does not have any failed migmigration remove the label
